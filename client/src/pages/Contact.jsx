...
export default function Contact(props) {
    ...
    return (
        ...
        <i  className="fa fa-linkedin-square" style={{fontSize:'36px',cursor: 'pointer'}}></i>
        </a>
        <br></br><br></br>
        <a href='https://drive.google.com/file/d/1IbKYlp14-xeuhLM_v26-tO7kLn5tb4NV/view?usp=sharing' download>
